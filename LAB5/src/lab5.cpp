...
{   
    ...
    cout<<"Metoda wypisujaca elementy wiersza 4 macierzy 5x6: ";
    cout<<macierz1[3]<<endl<<endl;
    ...
    macierz dodawanie=macierz1 + macierz3;
    dodawanie.print();
    macierz odejmowanie0=macierz1.subtract(macierz2);       //exception test
    macierz odejmowanie=macierz3 - macierz1;
    ...
    macierz iloczyn=macierz1 * macierz4;
